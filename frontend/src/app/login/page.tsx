    ...
    <div className="flex min-h-screen w-full font-sans">
          ...
          <div className="w-full max-w-[460px]">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <Field label="비밀번호">
                <div className="relative w-full h-12 min-h-[48px]">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 focus:outline-none select-none p-1 z-10"
                    aria-label={
              ...
              <div className="flex items-center justify-between text-sm text-gray-500 mt-1">
                ...
                <a href="/forgot" className="hover:text-gray-800">
                  아이디 · 비밀번호 찾기
                </a>
              </div>
              ...
              {/* 📱 선택적: 구글 로그인도 추가하고 싶다면 */}
              {/* <button
                type="button"
                className="w-full h-12 min-h-[48px] bg-white border border-gray-300 hover:border-gray-400 text-gray-700 font-medium rounded-lg flex items-center justify-center gap-2 transition-all"
              >
      ...
      <div className="hidden lg:flex w-1/2 bg-[#1a2133] relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 max-w-[500px] text-white">
          ...
          {/* 가로로 꽉 채워진 통계 박스 */}
          <div className="w-full bg-[#21293e] border border-gray-700/50 rounded-xl p-6 px-10 flex justify-between items-center shadow-lg">
            <div className="text-center">
              <div className="text-xl font-bold mb-1">
                <AnimatedNumber end={17000} suffix="+" />
              </div>
              <div className="text-xs text-gray-400">도입 기업</div>
            </div>
            <div className="text-center">
              <div className="text-xl font-bold mb-1">
                <AnimatedNumber end={35} suffix="종" />
              </div>
              <div className="text-xs text-gray-400">업무 기능</div>
            </div>
            <div className="text-center">
              <div className="text-xl font-bold mb-1">
                <AnimatedNumber end={99.9} decimals={1} suffix="%" />
              </div>
              <div className="text-xs text-gray-400">서비스 안정성</div>
            </div>
          </div>
        </div>
      </div>
